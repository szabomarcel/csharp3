...
namespace TestApp_ko_papir_ollo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                case 'k': playerChoice = "kő"; break;
                case 'p': playerChoice = "papí"; break;
                case 'o': playerChoice = "olló"; break;
            }
            switch (r.Next(0, 3)) 
            {
                case 0: compChoice ="kő"; break;
                case 1: compChoice = "papír"; break;
                case 2: compChoice = "olló"; break;
            }
            if (
            ...
            {
                Console.WriteLine("Döntetlen! Az állá:\nSzámítógép: {0}\nJátékos:{1}", ++compScore, playerScore);    
            }
            else 
            {
